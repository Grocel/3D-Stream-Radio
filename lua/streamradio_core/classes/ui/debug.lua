...
function CLASS:BuildLines()
	...
	addLine(self, 2, "  Think:          %7.3f ms | %5.1f%% of GM", addonthink_time * 1000, addonthink_time_p)
	addLine(self, 2, "  Tick:           %7.3f ms | %5.1f%% of GM", addontick_time * 1000, addontick_time_p)
	addLine(self, 2, "")
	addLine(self, 2, " Classes")
	addLine(self, 2, "  Think:          %7.3f ms | %5.1f%% of GM", think_time * 1000, think_time_p)
	addLine(self, 2, "  Fast Think:     %7.3f ms | %5.1f%% of GM", fastthink_time * 1000, fastthink_time_p)
	addLine(self, 2, "")
