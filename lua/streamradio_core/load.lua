...
ok = ok and loadSH("streamradio_core/language.lua")
ok = ok and loadSH("streamradio_core/bass3.lua")
ok = ok and loadSH("streamradio_core/lib.lua")
ok = ok and loadSH("streamradio_core/enum.lua")
ok = ok and loadSH("streamradio_core/error.lua")
...
ok = ok and loadSH("streamradio_core/properties.lua")
ok = ok and loadSH("streamradio_core/vr.lua")
ok = ok and loadSH("streamradio_core/wire.lua")
